...
def email_attachment(sender: str, destination: str,
    ...
    a.add_header('Content-Disposition',
                 'attachment; filename="ao3-ebook.mobi"')
...
def generate_config(dest: str) -> None:
    ...
    while True:
        ...
        print('(WARNING: will be stored as plaintext,'
...
def main() -> None:
    ...
    cli.add_argument('-c', dest='cfgfile',
                     ...
                     help='Location of config file (default: %s)'
                     % cfgfile_default)
    ...
    cli.add_argument('-v', '--verbose', action='store_true',
                     dest='verbose', help='Show verbose info')
    cli.add_argument('--debug', action='store_true',
                     dest='debug', help='Show debug info')
